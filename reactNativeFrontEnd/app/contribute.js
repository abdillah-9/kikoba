...
export default function viewBalance() {
  ...
  const handleSignUp = () => {
    ...
    fetch( 'https://6dc7-41-222-179-235.ngrok-free.app/myprojects/jsonKikoba/Contribute.php', {
      method: 'POST',
      headers: {
      ...
      .then(data => {
        ...
        Alert.alert('Hello', data.fname+" "+data.mname+" "+data.sname+"\n\n"+"You've added: "+amount+"Tsh"+"\n\n"+"Your new balance is: "+data.money+"Tsh");
        }
      })
      .catch(error => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Contribute Here</Text>
      <TextInput
        style={styles.input}
