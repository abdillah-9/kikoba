...
export default function chooseService(){
    ...
    return(
        <View style={styles.mainContainer}>
            ...
            {/* VIEW ALL USERS OF THE APP WITH THEIR LOANS */}
            <TouchableOpacity 
            style={[styles.submitButton, styles.blueBackground]}>
            <Link href={{ pathname:'viewUsersLoans', params: { id:id2} }}
            style={styles.submitButtonText}>Users list with Loans</Link>
            </TouchableOpacity>
            {/* -------------------- */}
            ...
            style={styles.submitButtonText}>Contribute {id.id}</Link>    
            </TouchableOpacity>
            {/* -------------------- */}
