...
export default function viewBalance() {
  ...
  const handleSignUp = () => {
    ...
    fetch('https://6dc7-41-222-179-235.ngrok-free.app/myprojects/jsonKikoba/Returnloan.php', {
      method: 'POST',
      headers: {
      ...
      .then(data => {
        ...
        if(data.status =="success"){
          Alert.alert('Hello', data.fname+" "+data.mname+" "+data.sname+"\n\n"+"Loan amount returned successful is: "+amount+"Tsh"+"\n\n"+"Debt remains: "+data.amountRemain+"Tsh");
        }
      })
      .catch(error => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Return Loan Debt</Text>
      <TextInput
        style={styles.input}
